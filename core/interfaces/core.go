...
type Services interface {
	...
	GetFileContentUploadURLs(claims *tokenauth.Claims, fileNames []string, category string) ([]string, error)
	GetFileContentDownloadURLs(claims *tokenauth.Claims, fileNames []string, category string) ([]string, error)
